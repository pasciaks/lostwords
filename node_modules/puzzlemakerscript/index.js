...
var PuzzleMakerScript = {
    ...
    /**
     * 
     * TODO allow for howmany times variable to guarantee hidden words make it there ???
        ...
        for (var i = 0; i < word.length; i++) {
            ...
            if (this.get(sx, sy) !== this.emptyChar) {
                ...
                if ((this.get(sx, sy) == word[i]) && (allowReuseLetters == true)) {
                    ...
                    return {
                        'result': 'already used letter and no reuse allowed',
                        'thePath': []
                    };
                }
