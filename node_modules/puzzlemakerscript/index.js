...
var PuzzleMakerScript = {
     ...
     * 
     * */
    createPath: function(sx, sy, word, allowReuseLetters, repickDirections) {
        ...
        if (this.get(sx, sy) !== this.emptyChar) {
            if (allowReuseLetters==false) {
                ...
                if (++toomany>100000) return { 'result':'bad start', 'thePath': [] };
        ...
        for ( var i=0;i<word.length;i++ ) {
            ...
            if (++failSafe>100000) {console.log("faile safe");return { 'result':'fail safe', 'thePath': [] };} //break;
            ...
            do {
                ...
                if (repickDirections) dir=this.pickDirection();
                ...
                if (sx<1) failed=true;
                if (sx>this.cols-1) failed=true;
                if (sy<1) failed=true;
                if (sy>this.rows-1) failed=true;
